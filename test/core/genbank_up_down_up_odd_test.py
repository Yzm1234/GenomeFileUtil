...
#         cls.serviceImpl.export_genome_as_genbank(cls.ctx, {'input_ref': result['genome_ref']})
...
#                     msg = (
#                         'The coordinates supplied for this feature are non-exact. '
#                         'DNA or protein translations are approximate.'
#                     )
#                     if msg in orig_feature["warnings"]:
#                         orig_feature["warnings"] = [
#                             warning for warning in orig_feature["warnings"]
#                             if warning != (
#                                 'The coordinates supplied for this feature are non-exact. '
#                                 'DNA or protein translations are approximate.'
#                             )
...
#             (f"There were {first_pass_matches} first pass matches and "
#              f"{second_pass_matches} second pass matches out of "
#              f"{len(orig_dict)} items in {feature_list_name}")
#         )
#
