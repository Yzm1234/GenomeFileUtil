...
#         # get metagenome data.
#         cls.gff_path = "data/metagenomes/toy/metagenome.gff"
#         cls.fasta_path = "data/metagenomes/toy/metagenome.fa"
#         # cls.gff_path = "data/metagenomes/toy/Test_v1.0.gene.gff"
#         # cls.fasta_path = "data/metagenomes/toy/Test_v1.0.fa"
...
#         ret = dfu.get_objects({'object_refs': [result['metagenome_ref']]})['data'][0]
#         metagenome  = ret['data']
#         info = ret['info']
#         # type_checks
#         self.assertTrue('KBaseMetagenomes.AnnotatedMetagenomeAssembly' in info[2])
