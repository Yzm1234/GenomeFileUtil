...
#             feature_list_name + " list is not of equal length in Original and New Genomes. orig to new diff: " +
#                 str(set([g['id'] for g in genome_orig[feature_list_name]]) - set([g['id'] for g in genome_new[feature_list_name]])) +
#                 "new to orig diff:" + str(set([g['id'] for g in genome_new[feature_list_name]]) - set([g['id'] for g in genome_orig[feature_list_name]]))
#         )
